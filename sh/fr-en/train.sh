...
#SBATCH --output=/project/jonmay_231/linghaoj/reproduce/slurm/debug-fr.out
#SBATCH --error=/project/jonmay_231/linghaoj/reproduce/slurm/debug-fr.err
#SBATCH --job-name=fr-base
#SBATCH --nodes=1
...
if [ -n "$src" ]; then src=$src ; else src=fr ; fi
