...
#SBATCH --nodes=1
#SBATCH --gpus=4
#SBATCH --job-name=repro-de-31-mega
...
CKPT=/gscratch/zlab/jyyh/canmt-challenges/ckpt/3-1-${model}-$src-$tgt-dp-${dp}-rs-${seed}

echo "TRAINING 3-1 MODEL!!!"

fairseq-train ${BIN} \
    --user-dir ${REPO} --save-dir ${CKPT} --next-sent-ctx \
