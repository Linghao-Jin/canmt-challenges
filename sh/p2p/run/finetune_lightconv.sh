...
#SBATCH --output=/project/jonmay_231/linghaoj/canmt-challenges/slurm/lightconv-wmt17-p2p.out
#SBATCH --error=/project/jonmay_231/linghaoj/canmt-challenges/slurm/lightconv-wmt17-p2p.err
#SBATCH --job-name=lightconv-wmt17-p2p
#SBATCH --nodes=1
